# OpenClaw-Cleanup
Some Clean Up Script to run before a ful lbackup or so.



## License
This m365 integration is licensed under the PolyForm Noncommercial License 1.0.0 (with additional terms).
